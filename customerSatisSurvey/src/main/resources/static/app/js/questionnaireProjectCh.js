...
$(function(){
	 ...
	 console.log("questionnaireProjectCh.js");
	...
	if (window.history && window.history.pushState) { 
	 ...
	 $('#evalDate').datetimepicker({
	    	...
	    	$('#fm_quesProjCh').data('bootstrapValidator')
	 ...
	 $("#fm_quesProjCh").bootstrapValidator({
...
//	 
	 ...
	 $("#quesProjCh_add").click(function(){
		
		Ewin.confirm({ message: "请确认是否提交问卷，提交问卷后问卷内容无法修复?" }).on(function (e) { 
		     if(!e){
		    	 return;
		     }
			 $('#fm_quesProjCh').bootstrapValidator('validate');
			 if($('#fm_quesProjCh').data('bootstrapValidator').isValid()){
