...
$(function(){
	 ...
	 console.log("questionnaireStaffEn.js");
	...
	if (window.history && window.history.pushState) { 
	 ...
	 $('#evalDate').datetimepicker({
	    	...
	    	$('#fm_quesStaffEn').data('bootstrapValidator')
	 ...
	 $("#fm_quesStaffEn").bootstrapValidator({
         ...
         fields: {
             ...
             evalPersonDep: {
                 validators: {
                      notEmpty: {
                    	  message: "evaluator department can not be empty!"
                      }
                 }
             },
             evalPersonName: {
                 validators: {
                      notEmpty: {
                    	  message: "name of evaluator can not be empty!"
                      }
                 }
             },
             evalDate: {
                 validators: {
                      notEmpty: {
                    	  message: "evaluation date can not be empty!"
                      },
                      date: {//验证指定的日期格式
                          format: 'yyyy-mm-dd',
...
//	 
	 ...
	 $("#quesStaffEn_add").click(function(){
		 ...
		 Ewin.confirm({ message: "Please confirm whether to submit the questionnaire, The content cannot be modified after submitting the questionnaire?" }).on(function (e) {
			 ...
			 $('#fm_quesStaffEn').bootstrapValidator('validate');
			 if($('#fm_quesStaffEn').data('bootstrapValidator').isValid()){
